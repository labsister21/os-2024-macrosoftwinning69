    ...
    uint8_t privilege)
{
    ...
    uint32_t handler_address_32 = (uint32_t)handler_address;

    idt_int_gate->offset_low = handler_address_32 & 0xFFFF;
    ...
    idt_int_gate->offset_high = (handler_address_32 >> 16) & 0xFFFF;
}
